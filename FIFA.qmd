...
#| label: fig-players-vs-performance
#| fig-cap: "Performance (Goals + Assists) vs. Number of Players on Team"
#| fig-alt: "Scatter plot showing the relationship between number of players and team performance measured by goals and assists in the 2022 World Cup. France, Argentina, and Portugal had some of the highest performance values."
#| fig-pos: H
#| fig-height: 5
ggplot(worldCupClean, aes(x = players, y = goals_plus_assists, color = squad)) +
  geom_point(size = 3) +
